...
$('.fade').slick({
    ...
    cssEase: 'linear',
    speed: 1500,
    prevArrow: '<button type="button" class="slick-prev"><img src="../img/photo/left.svg"></button>',
    nextArrow: '<button type="button" class="slick-next"><img src="../img/photo/right.svg"></button>',
    arrows: false,
});